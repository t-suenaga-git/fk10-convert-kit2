    ...
    Public Class Ky_kosinkai_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[初回契約日],[契約状況(ステータス)],[キャンセル理由],[ステータス変更日],[仲介業者No],[取引主任者No],[手付預り額①],[手付預り日①],[手付預り備考①],[解約フラグ],[サービス分類],[会計グループ分類],[解約受付区分],[解約受付月数],[解約受付日数],[解約受付日にち],[仲介担当者名],[仲介担当者名SJIS],[契約開始日],[契約終了日]"
    ...
    Public Class Ky_kosinkai_kys_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[契約管理レコードNo],[並び順No],[契約者No],[入居フラグ]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_kazoku_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[契約管理レコードNo],[入居者No],[契約者No],[氏名],[氏名Unicode],[カナ],[性別],[続柄],[生年月日],[勤務先],[連絡先],[携帯電話番号],[備考]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_kosinkai_hosyonin_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[契約管理レコードNo],[並び順],[契約者No],[保証人No]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_car_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[契約管理レコードNo],[車情報No],[メーカー],[車名],[車色],[ナンバー],[備考],[駐車区画]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class ky_Hoken_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[保険種類No],[保険業者No],[契約日],[適用開始年月日],[適用終了年月日],[保険金額],[満期案内通知有無],[備考],[証券番号]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_biko_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件NO],[部屋NO],[契約NO],[契約管理レコードNo],[メモ1],[メモ2],[メモ3],[メモ4],[メモ5],[メモ6],[メモ7],[メモ8],[メモ9],[メモ10],[メモ11],[メモ12],[メモ13],[メモ14],[メモ15],[メモ16],[メモ17],[メモ18],[メモ19],[メモ20],[メモ21],[メモ22],[メモ23],[メモ24],[メモ25],[メモ26],[メモ27],[メモ28],[メモ29],[メモ30],[メモ31],[メモ32],[メモ33],[メモ34],[メモ35],[メモ36],[メモ37],[メモ38],[メモ39],[メモ40],[メモ41],[メモ42],[メモ43],[メモ44],[メモ45],[メモ46],[メモ47],[メモ48],[メモ49],[メモ50]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_sqdata_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[契約管理レコードNo],[月区分],[入金項目名],[入金項目レコードNo],[並び順No],[入金項目区分],[請求額],[税区分],[請求税額],[算出区分],[算出基準入金項目名],[算出ヶ月],[請求先No],[入金方法],[請求月区分],[フリーレント適用開始日],[フリーレント適用終了日],[フリーレント終了月請求額],[請求開始月],[請求パターン],[請求間隔],[請求発生年],[請求発生月],[適用税率],[備考],[フリーレント適用区分]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_sqdata_nx_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[契約管理レコードNo],[月区分],[入金項目名],[入金項目レコードNo],[並び順No],[入金項目区分],[請求額],[税区分],[請求税額],[算出区分],[算出基準入金項目名],[算出ヶ月],[請求先No],[入金方法],[請求月区分],[請求開始月],[請求パターン],[請求発生間隔],[請求対象年],[請求対象月],[適用税率],[備考]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_sqdata_hendo_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[契約管理レコードNo],[変動費No],[請求対象フラグ],[メーター分類],[メーター名],[入金項目名],[変動費請求ルールNo],[変動費請求ルール備考],[請求先No],[入金方法],[備考],[請求月]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_sqdata_kojo_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[契約管理レコードNo],[対象区分],[控除入金項目名],[表示順],[相殺予定フラグ],[控除額算出基準],[控除額],[控除額税区分],[控除対象入金項目名],[控除率],[控除率税区分],[控除率内税],[適用税率],[立替回収または預り金],[控除税額],[送金対象フラグ],[送金対象入金項目名]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_sqdata_sorule_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[契約管理レコードNo],[対象区分],[入金項目名],[表示順],[送金率],[管理手数料率],[滞納保証有無]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Ky_kosinkai_kai_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                Dim szenopflg As Boolean = Njc.Frm.MainFrm.chkOptionSelectReform.Checked
                ...
                tmp_sql = tmp_sql & " 	) AS KYTOTAL "
                '20160629 修繕検証後修正 -add
                tmp_sql = tmp_sql & Me.Get_UseQry_SzenOp(szenopflg)
                tmp_sql = tmp_sql & " ) AS VW "
            ...
            ''' <returns></returns>
            ''' <remarks></remarks>
            Public Function Get_UseQry_SzenOp(ByVal opflg As Boolean) As String
    ...
    Public Class Reform_data_kaiszen_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[更新No],[見積No],[見積タイトル],[見積番号],[見積日],[成約フラグ],[成約日],[負担区分(全体・個別)],[契約者負担率(全体用)],[家主負担率(全体用)],[自社負担率(全体用)],[税適用区分(全体・個別)],[税区分(全体用)],[適用税率],[契約者税額(全体用)],[家主税額(全体用)],[自社税額(全体用)],[端数負担者区分]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Reform_item_kaiszen_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[部屋No],[契約No],[更新No],[見積No],[見積明細No],[修繕項目名],[摘要],[見積数量],[見積単位],[見積単価],[見積税区分],[見積税額(税入力用)],[契約者負担率(個別用)],[家主負担率(個別用)],[自社負担率(個別用)],[発注業者No],[実行数量],[実行単位],[実行単価],[実行税区分],[実行税額(税入力用)]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
