    ...
    Public Class Sq_unyomisyutaino_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                tmp_sql = tmp_sql.Replace("運用開始年月置換用文字列", UnyoYMD)
    ...
    Public Class Sq_koteikojo_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                Dim tmp_midheader As String = "[物件No],[入金項目ソートNo],[入金項目名],[部屋No],[相殺フラグ],[額],[税区分],[税額],[入金区分],[家賃入金口座No],[適用開始該当年月],[適用終了該当年月],[立替・預りフラグ],[控除請求月区分],[控除請求発生パターン],[控除請求発生間隔],[控除請求発生月指定年区分],[控除請求発生月指定月区分],[適用税率],[備考],[請求締区分],[領収フラグ]"
