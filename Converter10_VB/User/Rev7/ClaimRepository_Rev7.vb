    ...
    Public Class Claim_data_Base_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                Dim tmp_midheader As String = "[クレームNo],[対応状況],[タイトル],[受付日時],[受付担当者],[連絡者名],[連絡者TEL1],[連絡者TEL2],[連絡可能時間（開始）],[連絡可能時間（終了）],[緊急度],[対応期限],[箇所分類No],[クレーム分類No],[内容],[対応担当者],[電子メール備考],[物件No],[部屋番号],[契約No],[契約レコードNo],[対応先区分],[依頼業者No],[業者担当者],[業者担当者TEL],[完了日時],[結果入力],[負担者1],[負担者1金額等],[負担者2],[負担者2金額等],[負担者3],[負担者3金額等],[備考],[自社・支店No],[自社・支店名],[受付時刻],[対応終了時刻],[連絡者名SJIS],[対応担当者名SJIS],[家主No]"
    ...
    Public Class Claim_data_taiorireki_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[クレームNo],[対応履歴No],[対応日時],[対応担当者],[内容],[対応時刻]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Claim_data_relfile_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[クレームNo],[ファイルNo],[ファイルパス],[追加日],[備考]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
