    ...
    Public Class Reform_data_Mitumori_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[修繕No],[見積No],[見積タイトル],[見積番号],[見積日],[成約フラグ],[成約日],[負担区分(全体・個別)],[契約者負担率(全体用)],[家主負担率(全体用)],[自社負担率(全体用)],[税適用区分(全体・個別)],[税区分(全体用)],[適用税率],[契約者税額(全体用)],[家主税額(全体用)],[自社税額(全体用)],[端数負担者区分]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Reform_item_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[修繕No],[見積No],[見積明細No],[修繕項目名],[摘要],[見積数量],[見積単位],[見積単価],[見積税区分],[見積税額(税入力用)],[契約者負担率(個別用)],[家主負担率(個別用)],[自社負担率(個別用)],[発注業者No],[実行数量],[実行単位],[実行単価],[実行税区分],[実行税額(税入力用)]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Reform_data_claim_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[修繕No],[クレームNo],[クレーム画面での並び順],[修繕情報登録画面での並び順]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
...
#Region "修繕関連ファイル情報"    '20160627 修繕関連ファイル移行修正
    ...
    Public Class Reform_data_relfile_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[修繕No],[ファイルNo],[ファイルパス],[追加日],[備考]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Reform_jyuyo_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[物件No],[修繕No],[備考1],[備考2],[備考3],[備考4],[備考5],[備考6],[備考7],[備考8],[備考9],[備考10],[備考11],[備考12],[備考13],[備考14],[備考15],[備考16],[備考17],[備考18],[備考19],[備考20],[備考21],[備考22],[備考23],[備考24],[備考25],[備考26],[備考27],[備考28],[備考29],[備考30],[備考31],[備考32],[備考33],[備考34],[備考35],[備考36],[備考37],[備考38],[備考39],[備考40],[備考41],[備考42],[備考43],[備考44],[備考45],[備考46],[備考47],[備考48],[備考49],[備考50]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
