    ...
    Public Class M_bus_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                Dim tmp_midheader As String = "[バス交通No],[バス停No],[系統名],[バス停名]"
    ...
    Public Class M_biko4_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[鍵No],[鍵名称]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class Claim_data_Rev7_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[箇所・クレーム分類区分],[分類No],[名称]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class M_tokuyaku_Rev7_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[特約区分],[特約No],[特約タイトル],[特約詳細]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class M_hoken_rui_Rev7_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[保険種類No],[保険種類名],[保険種類カナ],[備考]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class M_school_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[県No],[市No],[学校区No],[町],[丁目],[番地],[小学校名],[中学校名]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class M_addkbn_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[エリアNo],[エリア名]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class M_hendo_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[ルールNo],[ルール名],[その他単位],[その他単位SJIS],[料金数],[分類],[端数処理],[端数処理パターン],[口径],[備考],[計上分類],[税区分早見],[税区分単価]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class M_hendo_mei_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[変動費ルールNo],[行No],[使用量],[料金１],[料金２],[料金３],[料金４],[料金５]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class M_biko_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[備考区分],[備考No],[備考タイトル],[使用有無],[補助アイテム使用有無]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
    ...
    Public Class M_biko_lst_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[備考区分],[備考No],[備考入力補助リストNo],[備考入力補助リスト内容]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
...
#Region "画像タイトルマスタ"  '20160801 タイトルマスタ統合処理 -add
    ...
    Public Class M_gazo_syoki_Repository
        ...
        Public Class SubConv
            ...
            Function Get_UseQry(ByRef sortstr As String) As String Implements IConv.Get_UseQry
                ...
                '抽出データの改行文字列を除去する暫定処理
                Dim tmp_midheader As String = "[画像区分],[画像No],[画像名]"
                Dim tmp_chgmidheader As String = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, True)
                '抽出データの改行文字列を除去する暫定処理
