Module MidTableModule

    Public Function MakeMidTable(ByVal midsheetname As String, ByVal replacetblname As String) As String

        Dim tmp_sql As String = ""
        Dim tmp_sql_pre As String = " CREATE TABLE " & replacetblname & "("
        Dim tmp_sql_post As String = ")"

        Select Case midsheetname
            Case "各マスタ情報@#@バス交通マスタ"
        ...
        '結合
        Dim rtn_sql As String = tmp_sql_pre & tmp_sql & tmp_sql_post
        Return rtn_sql
