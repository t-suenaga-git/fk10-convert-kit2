    ...
    public class Bk_mst_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                string tmp_midheader = "[物件NO],[物件名],[物件カナ],[建物識別コード],[郵便番号],[都道府県コード],[市区町村コード],[町地域],[丁番地],[街区番号地番],[その他],[物件名(SJIS)],[物件外部No]";
    ...
    public class Bk_mst_syo_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[物件No],[管理No],[貸主１No],[所有者１No],[貸主２No],[所有者２No],[所有期間開始],[所有期間終了]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class Bk_mst_gomi_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[物件NO],[ゴミ情報No],[ゴミ分類],[ゴミ出し曜日]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class Bk_mst_kagi_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[物件No],[鍵No],[鍵タイトル名],[鍵本数],[備考],[保管場所],[業者間での情報共有]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class Bk_Jyuyo_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[物件No],[権利情報No],[所有権以外の権利の有無],[所有権以外の権利の種類],[内容]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class Bk_eki_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[物件NO],[内部No],[沿線No],[駅No],[始発フラグ],[距離],[徒歩],[車],[バス],[バス会社],[バス停],[バス停徒歩],[バス停までの距離],[設定する交通のタイプ],[バス系統・路線名(駅までバスを利用)],[バス停名(駅までバスを利用)],[バス停(駅までバスを利用)までの道路距離],[バス停(駅までバスを利用)までの徒歩(分)],[車距離]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class Bk_mst_setudo_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[物件NO],[接道No],[方角],[道路種],[幅員],[接道距離],[位置指定道路]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class Bk_mst_syuhen_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[物件NO],[周辺No],[周辺施設分類],[周辺施設名],[周辺施設距離]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class Bk_setubi_ren_bk_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[物件NO],[修繕及び維持管理No],[修繕及び維持管理の箇所],[対象区分],[業者no],[氏名(商号または名称)(SJIS)],[住所(主たる事務所の所在地)],[連絡先電話番号],[自社no],[貸主No],[所有者No],[氏名(商号または名称)]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class Bk_biko_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[物件NO],[備考1],[備考2],[備考3],[備考4],[備考5],[備考6],[備考7],[備考8],[備考9],[備考10],[備考11],[備考12],[備考13],[備考14],[備考15],[備考16],[備考17],[備考18],[備考19],[備考20],[備考21],[備考22],[備考23],[備考24],[備考25],[備考26],[備考27],[備考28],[備考29],[備考30],[備考31],[備考32],[備考33],[備考34],[備考35],[備考36],[備考37],[備考38],[備考39],[備考40],[備考41],[備考42],[備考43],[備考44],[備考45],[備考46],[備考47],[備考48],[備考49],[備考50]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
