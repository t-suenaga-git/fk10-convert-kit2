    ...
    public class M_kan_Base_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                tmp_sql = tmp_sql.Replace("運用開始年月置換用文字列", "CONVERT(VARCHAR,CONVERT(DATETIME,'" + CommonModule.UnyoYMD + "'),111)");
                return tmp_sql;
    ...
    public class M_kan_Zei_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[No],[税率],[適用開始],[適用終了],[備考]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class M_kan_Henkanmoji_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[No],[変換前],[変換後]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
    ...
    public class M_kan_Nkinkomkmerge_Repository
    {
        ...
        public class SubConv : IConv
        {
            ...
            public string Get_UseQry(ref string sortstr)
            {
                ...
                // 抽出データの改行文字列を除去する暫定処理
                string tmp_midheader = "[集約区分],[入金項目集約設定No],[入金項目集約設定名],[入金項目区分1],[入金項目No1],[入金項目名1],[入金項目区分2],[入金項目No2],[入金項目名2],[入金項目区分3],[入金項目No3],[入金項目名3],[入金項目区分4],[入金項目No4],[入金項目名4],[入金項目区分5],[入金項目No5],[入金項目名5],[入金項目区分6],[入金項目No6],[入金項目名6],[入金項目区分7],[入金項目No7],[入金項目名7],[入金項目区分8],[入金項目No8],[入金項目名8],[入金項目区分9],[入金項目No9],[入金項目名9],[入金項目区分10],[入金項目No10],[入金項目名10],[入金項目区分11],[入金項目No11],[入金項目名11],[入金項目区分12],[入金項目No12],[入金項目名12],[入金項目区分13],[入金項目No13],[入金項目名13],[入金項目区分14],[入金項目No14],[入金項目名14],[入金項目区分15],[入金項目No15],[入金項目名15],[入金項目区分16],[入金項目No16],[入金項目名16],[入金項目区分17],[入金項目No17],[入金項目名17],[入金項目区分18],[入金項目No18],[入金項目名18],[入金項目区分19],[入金項目No19],[入金項目名19],[入金項目区分20],[入金項目No20],[入金項目名20]";
                string tmp_chgmidheader = EtcMethod.Get_FldnameAddReplaceMethod(tmp_midheader, true);
                // 抽出データの改行文字列を除去する暫定処理
