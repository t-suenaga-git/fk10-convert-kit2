...
namespace Converter10.Njc.Repository
{
    ...
    public class Hy_cyusyajo_mid_Repository
    {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public bool Read_BaseMidFile(SqlConnection sqlcnnv10, Dictionary<string, 中間ファイル紐づけ情報> dic, List<object> DbSet, string tblname)
        {
            ...
            var obj_com = new CommonRepository();
            ...
            try
            {
                ...
                // dt.Load(dr)
                // 20161021 既存中間ファイルを無くすことによる速度改善処理_個別コピー処理_不要処理削除 -del end
                int colcnt = DbSet.Count;
                int readrowcnt = 1;
                var solist_header = new SortedList<int, string>();
                ...
                foreach (var row in DbSet)
                {
                    ...
                    foreach (var tmp_baseheader in dic.Keys)
                    {
                        ...
                        if (!string.IsNullOrEmpty(entityColName))
                        {
                            ...
                            if (tmp_basevalue is null)
                            {
                                tmp_basevalue = "";
                            }
                            tmp_basevalue.Replace("'", "’");
                            // 20161125 仮テーブル作成時に「'」を全角変換する処理を追加 -add end
                            if (!string.IsNullOrEmpty(tmp_baseheader))
                            {
                                tmp_hash.Add(tmp_baseheader, tmp_basevalue);
                            }
                        }
                    ...
                    for (int cntkbn = 1; cntkbn <= 1; cntkbn++) // 1 To 3→1 To 1
                    {

                        var insertvalue_sb = new System.Text.StringBuilder();
                        var chk_sb = new System.Text.StringBuilder();
                        bool insertflg = true;

                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject("'", tmp_hash["物件NO"]), "'"));
                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["部屋NO"]), "'"));
                            ...
                            case 1:
                                {
                                    ...
                                    // 空の場合は挿入処理を行わない
                                    if (string.IsNullOrEmpty(chk_sb.ToString().Trim()))
                                    {
                                        insertflg = false;
                                    }
                                    else
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐車場の空き数(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐車場の空き有無(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐車場料金区分(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐車場料金(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐車場料金税区分(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐車場の賃貸可能数"]), "'"));
                                    }
                            ...
                            case 2:
                                {
                                    ...
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["バイクの空き数(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["バイク駐車場の空き有無(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["バイク駐車場料金区分(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["バイク駐車場料金(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["バイク駐車場料金税区分(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["バイク駐車場の賃貸可能数"]), "'"));
                                    }
                            ...
                            case 3:
                                {
                                    ...
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐輪場駐車場の空き数(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐輪場駐車場の空き有無(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐輪場駐車場料金区分(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐輪場駐車場料金(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐輪場駐車場料金税区分(手動設定用)"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["駐輪場駐車場の賃貸可能数"]), "'"));
                                    }
                        ...
                        if (insertflg)
                        {
                            ...
                            string taisyo = "[物件NO],[部屋NO],[駐車場区分],[駐車場の空き数(手動設定用)],[駐車場の空き有無(手動設定用)],[駐車場料金区分(手動設定用)],[駐車場料金(手動設定用)],[駐車場料金税区分(手動設定用)],[駐車場の賃貸可能数]";
                            ...
                            qry += " VALUES ";
                            qry += "(" + insertvalue_sb.ToString() + ")";
                            DBExec.Exec_NonQuery(sqlcnnv10, qry, ref tmp_cnt);
        ...
        public bool Read_BaseMidFile(SqlConnection sqlcnnv10, Dictionary<string, 中間ファイル紐づけ情報> dic, List<object> DbSet, string tblname)
        {
            ...
            try
            {
                ...
                foreach (var row in DbSet)
                {
                    ...
                    for (int cntkbn = 1; cntkbn <= 3; cntkbn++)
                    {
                            ...
                            case 1:
                                {
                                    ...
                                    // 空文字チェック
                                    chk_str = Conversions.ToString(Interaction.IIf(tmp_hash["その他特約内容"] is null, "", tmp_hash["その他特約内容"]));

                                    // 空の場合は挿入処理を行わない
                                    if (string.IsNullOrEmpty(chk_str.Trim()))
                                    {
                                        insertflg = false;
                                    }
                                    else
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["その他特約内容"]), "'"));
                                    }
                            ...
                            case 2:
                                {
                                    ...
                                    // 空文字チェック
                                    chk_str = Conversions.ToString(Interaction.IIf(tmp_hash["原状回復特約内容"] is null, "", tmp_hash["原状回復特約内容"]));
                                    ...
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["原状回復特約内容"]), "'"));
                                    }
                            ...
                            case 3:
                                {
                                    ...
                                    // 空文字チェック
                                    chk_str = Conversions.ToString(Interaction.IIf(tmp_hash["入居中修繕特約内容"] is null, "", tmp_hash["入居中修繕特約内容"]));
                                    ...
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["入居中修繕特約内容"]), "'"));
                                    }
                        ...
                        if (insertflg)
                        {
                            ...
                            string taisyo = "[物件NO],[部屋NO],[特約区分],[内容1]";
                ...
                foreach (var row in DbSet)
                {
                    ...
                    for (int cntkbn = 1; cntkbn <= 3; cntkbn++)
                    {
                            ...
                            case 1:
                                {
                                    ...
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["契約者No1"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["入居フラグ1"]), "'"));
                                    }
                            ...
                            case 2:
                                {
                                    ...
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["契約者No2"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["入居フラグ2"]), "'"));
                                    }
                            ...
                            case 3:
                                {
                                    ...
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["契約者No3"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["入居フラグ3"]), "'"));
                                    }
                        ...
                        if (insertflg)
                        {
                            ...
                            string taisyo = "[物件NO],[部屋NO],[並び順No],[契約者No],[入居フラグ]";
        ...
        public bool Read_BaseMidFile(SqlConnection sqlcnnv10, Dictionary<string, 中間ファイル紐づけ情報> dic, List<object> DbSet, string tblname)
        {
            ...
            try
            {
                ...
                foreach (var row in DbSet)
                {
                    ...
                    for (int cntkbn = 1; cntkbn <= 2; cntkbn++)
                    {
                            ...
                            case 1:
                                {
                                    ...
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["保証人使用契約者No"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["保証人No1"]), "'"));
                                    }
                            ...
                            case 2:
                                {
                                    ...
                                    {
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["保証人使用契約者No"]), "'"));
                                        insertvalue_sb.Append(Operators.ConcatenateObject(Operators.ConcatenateObject(",'", tmp_hash["保証人No2"]), "'"));
                                    }
                        ...
                        if (insertflg)
                        {
                            ...
                            string taisyo = "[物件NO],[部屋NO],[並び順],[契約者No],[保証人No]";
